        ...
        return () => {
            switch (type) {
                case 'info':
                    ...
                    break;
                    case 'success':
                        NotificationManager.success(message, messagaTitle, 30000);
                        break;
                        case 'warning':
                            NotificationManager.warning(message, messagaTitle, 30000);
                            break;
                            case 'error':
                                NotificationManager.error(message, messagaTitle, 10000, () => {
                                 console.log('Error')
                        });
                        break;
                        default:
